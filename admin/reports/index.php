...
?>
<div class="mb-6"><h1 class="text-lg font-bold text-slate-900">Reports Center</h1><p class="text-xs text-slate-500">Download system reports</p></div>
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
    <?php
    $reports = [
        ['Applications', 'Export all exchange applications', '/admin/reports/export-applications.php'],
        ['Students', 'Export student directory', '/admin/reports/export-students.php'],
        ['Documents', 'Export document registry', '/admin/reports/export-documents.php'],
    ];
    foreach ($reports as [$title, $desc, $href]):
    ?>
    <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-6 card-hover">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div><h2 class="font-semibold text-slate-900 text-sm"><?= e($title) ?></h2><p class="text-xs text-slate-500"><?= e($desc) ?></p></div>
        </div>
