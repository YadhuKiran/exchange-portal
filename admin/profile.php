...
?>
        ...
        <form method="post" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="<?= url('/admin/index.php') ?>" class="px-6 py-2.5 rounded-xl border border-slate-200 text-sm font-medium text-slate-600 hover:bg-slate-50 transition-all">Cancel</a>
            </div>
        </form>
    </div>
</div>
